...
const medicineSchedule = {
    morning: {
        time: '08:00',
        greeting: 'Good morning Dear friend! Rise and shine!',
        message: 'Start your day right with your morning medicines:',
        medicines: ['Metformin - 500mg', 'Vitamin D3']
    },
    afternoon: {
        time: '14:00',
        greeting: 'Hey Dear friend! Hope you are having a good day!',
        message: 'Time for your afternoon medicines:',
        medicines: ['Calcium']
    },
    night: {
        time: '21:00',
        greeting: 'Good evening Dear friend! Before you wind down...',
    ...
    medicineStock.forEach(medicine => {
        ...
        if (medicine.total <= medicine.lowStockThreshold) {
            showAlertNotification(
                'Medicine Alert',
                `Hi Dear friend! Your ${medicine.name} is running low. Only ${medicine.total} tablets left. Please refill soon!`
            );
        }
        ...
        if (expiryInfo) {
            ...
            if (daysUntilExpiry <= 30 && daysUntilExpiry > 0) {
                showAlertNotification(
                    'Medicine Alert',
                    `Hi Dear friend! Your ${medicine.name} will expire in ${daysUntilExpiry} days. Please plan to get a refill.`
                );
            }
        }
    });
